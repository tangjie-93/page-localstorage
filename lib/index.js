    ...
    LocalStorageClass.prototype = {
        ...
        */
        setStorage (...args) {
            ...
            //为页面设置keys数组
            if (this.pageName) {
                this._setItem(`${this.pageName}:${PAGE}`, this.storageKeys.join(","));
                //避免页面刷新获取不到页面keys的问题
        ...
        /**
         * 删除特定key对应的本地缓存
         * @param {Array} filterkeys  过滤的keys
         * @param  {Array} args needRmKeys 需要删除的key
         */
        removeStorage ({ filterkeys = [], needRmKeys = [] }) {
            ...
            if (!needRmKeys || needRmKeys.length === 0) {
